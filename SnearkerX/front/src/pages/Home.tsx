        ...
        <div className={"home-container"}>
                        ...
                        <Carousel>
                            <Carousel.Item interval={2000}>
                                <img
                                    ...
                                    src="../images/Plantdecor/first.png"
                                    alt="First slide"
                                />
                            </Carousel.Item>
                            <Carousel.Item interval={2000}>
            ...
            <div className={"home-footer"}>
                <div className={"home-get-help"}>
                    ...
                    <span>@2024 classic motto Pvt. Ltd. All Rights Reserved</span>
